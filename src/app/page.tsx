...
const modules = [
  ...
  { icon: "📦", name: "Product Inventory", desc: "Chemical and fertilizer product catalog with stock levels, reorder alerts, and unit costs — know what's on the shelf before you spray.", tags: ["Stock Levels", "Reorder Alerts", "Product Catalog"], tier: 2 },
  ...
  { icon: "👥", name: "Team & Roles", desc: "Invite your crew with role-based permissions — owner, superintendent, assistant, crew lead, and crew.", tags: ["Invites", "Roles", "Permissions"], tier: 2 },
  { icon: "💬", name: "Team Chat", desc: "A shared channel plus direct messages for the whole crew, with push notifications so nobody has to keep the app open.", tags: ["Group + DMs", "Push Notifications"], tier: 3 },
  { icon: "🗺", name: "Course Map", desc: "A satellite view of the course where managers drop pins with notes — irrigation issues, turf problems, maintenance — the whole crew can see.", tags: ["Satellite View", "Pinned Notes"], tier: 3 },
